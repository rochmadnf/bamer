...
@section('content')
    ...
    <form id="formCheck" class="mt-6 shadow-0 shadow-slate-300 py-4 px-4 rounded-md bg-white">
        <div class="mb-4">
            <label class="text-sm block mb-2" for="kesamaan">Bagaimana kesamaan sifat Bawang Merah?</label>
            <select id="kesamaan" name="kesamaan" disabled
                class="border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-rose-500 focus:border-rose-500 block w-full p-2">
                <option selected disabled>Seragam</option>
            </select>
        </div>
        ...
        <div class="mb-4">
            <label class="text-sm block mb-2" for="kekeringan">Bagaimana kondisi saat Bawang Merah disimpan?</label>
            <select id="kekeringan" name="kekeringan" disabled
                class="border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-rose-500 focus:border-rose-500 block w-full p-2">
                <option selected disabled>Simpan Kering</option>
            </select>
        </div>

        <div class="mb-4">
            <label class="text-sm block mb-2" for="kotoran">Apakah terdapat kotoran pada Bawang Merah?</label>
            <select id="kotoran" name="kotoran" disabled
                class="border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-rose-500 focus:border-rose-500 block w-full p-2">
